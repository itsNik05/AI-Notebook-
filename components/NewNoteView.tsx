...
export const NewNoteView: React.FC<NewNoteViewProps> = ({ onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-lg z-50 flex flex-col p-4 animate-fade-in">
      <div className="flex-shrink-0 flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold text-cyan-400">New Note</h2>
